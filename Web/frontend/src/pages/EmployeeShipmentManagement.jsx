...
const EmployeeShipmentManagement = () => {
  ...
  const availableStatuses = [
    ...
    { value: "In Transit", label: "في الطريق", color: "bg-blue-100 text-blue-800" },
    { value: "في انتظار الشحن", label: "في انتظار الشحن", color: "bg-orange-100 text-orange-800" },
    { value: "Arrived", label: "وصلت", color: "bg-green-100 text-green-800" },
    { value: "في انتظار وصول الإذن", label: "في انتظار وصول الإذن", color: "bg-purple-100 text-purple-800" },
    { value: "Customs Clearance", label: "التخليص الجمركي", color: "bg-indigo-100 text-indigo-800" },
    { value: "جاري الكشف والتثمين", label: "جاري الكشف والتثمين", color: "bg-pink-100 text-pink-800" },
    { value: "Completed", label: "مكتملة", color: "bg-green-100 text-green-800" },
    { value: "تمت بنجاح", label: "تمت بنجاح", color: "bg-teal-100 text-teal-800" },
  ];
  ...
  const handleAddRequiredDocument = () => {
    if (newDocument.trim()) {
      setRequiredDocuments([...requiredDocuments, { name: newDocument, uploaded: false }]);
      setNewDocument('');
          ...
          {shipment && (
            <>
              ...
              <div className="bg-gradient-to-r from-red-50 to-orange-50 border border-red-200 rounded-xl p-6 mb-8">
                ...
                <div className="flex flex-col md:flex-row items-center justify-center gap-4">
                  ...
                  <div className="text-center">
                    ...
                    <span className={`inline-block px-4 py-2 rounded-full text-sm font-bold ${getStatusColor(shipment.status)}`}>
                      {availableStatuses.find(s => s.value === shipment.status)?.label || shipment.status}
                    </span>
                  </div>
                      ...
                      <div className="absolute top-full left-0 mt-2 w-64 bg-white rounded-lg shadow-xl border border-gray-200 z-50 max-h-96 overflow-y-auto">
                        <div className="p-2">
                          {availableStatuses.map((status) => (
                            ...
                            >
                              <span className={`inline-block px-3 py-1 rounded-full text-sm ${status.color} mb-1`}>
                                {status.label}
                              </span>
                            </button>
                          ))}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6 mt-12 mb-12">
                ...
                <Datafield 
                  label="الحالة" 
                  value={availableStatuses.find(s => s.value === shipment.status)?.label || shipment.status}
                  icon={<img src={contractIcon} alt="icon" className="w-5 h-5"  />} 
                />
                <Datafield 
                  label="وصف الشحنة" 
              ...
              <div className="flex flex-col sm:flex-row justify-center items-center gap-4 mt-12">
                <button 
                  ...
                  <img src={supportAgent} alt="Support Agent" className="w-6 h-6 filter brightness-0 invert" />
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-6">
            ...
            <div className="flex justify-center mb-6">
              <span className={`inline-block px-6 py-3 rounded-full text-lg font-bold ${getStatusColor(selectedStatus)}`}>
          ...
          <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full p-6 max-h-[90vh] overflow-y-auto">
            ...
            <div className="flex gap-2 mb-4">
              <input
                ...
                onKeyPress={(e) => e.key === 'Enter' && handleAddRequiredDocument()}
