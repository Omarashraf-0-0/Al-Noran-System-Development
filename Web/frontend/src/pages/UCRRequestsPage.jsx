...
import { Search, Filter, SortAsc, ChevronLeft, ChevronRight, ChevronsLeft, ChevronsRight, FileText, AlertCircle, Globe, LayoutGrid, List } from "lucide-react";
...
export default function UCRRequestsPage() {
	...
	useEffect(() => {
		setCurrentPage(1);
	}, [searchTerm, statusFilter, sortOption, viewMode]);
