...
const ServiceTabs = () => {
	...
	return (
		<section id="services" className="py-20 md:py-28 bg-gradient-to-b from-gray-50 to-white relative overflow-hidden">
			...
			<div className="container mx-auto px-4 relative z-10">
				...
				<div className="text-center mb-16">
					<span className="inline-block px-4 py-2 bg-[#690000]/10 text-[#690000] rounded-full text-sm font-bold mb-4">
						خدماتنا المميزة
					</span>
				...
				<div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
					{services.map((service, index) => (
						<div
							key={service.id}
							className="group relative bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-3 p-8 overflow-hidden border border-gray-100 hover:border-[#1ba3b6]/30"
						...
						>
							...
							<div className="mb-6 relative">
								<div className="w-20 h-20 mx-auto bg-[#690000]/10 rounded-2xl flex items-center justify-center group-hover:bg-[#690000] group-hover:text-white text-[#690000] transition-all duration-300 group-hover:scale-110 group-hover:rotate-3">
									{service.icon}
								</div>
							</div>

							{/* Title */}
							<h3 className="text-2xl font-bold text-center text-gray-800 mb-4 group-hover:text-[#690000] transition-colors">
								{service.label}
							</h3>
