...
/** Icon props: className (string), color (string, optional) */

export const LogoIcon = ({ className, color = 'currentColor' }) => (
  <div className={`flex items-center font-bold text-2xl ${className}`} style={{ color }}>
    <svg
    ...
    >
      ...
      <path d="M16 8h-4l-2 3h8l-2-3z" />
      <path d="M12 22V12" />
    </svg>
    <span className="self-center">مسارات</span>
  </div>
);
...
export const SortIcon = ({ className }) => (
  <svg
    ...
    strokeLinejoin="round"
  >
    <path d="M3 4h18M3 8h18M3 12h18M10 16l4 4 4-4" />
  </svg>
);
